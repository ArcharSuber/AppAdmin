...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="<?php echo U('Index/head');?>"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="<?php echo U('Index/left');?>" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="<?php echo U('Index/main');?>" name="main" scrolling="yes" noresize="noresize"
